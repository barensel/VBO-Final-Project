...
def part2(var,conditional_var, norm_var, norm_cvar, t_var, t_cvar, cc, ch, lh, avg_score_cc, avg_score_lc, avg_score_lh,genre):
    ...
    st.markdown(
        f"<div>Rate of return for this portfolio with Close-Close: <span class='highlight red'>{cc}</span></span></div>",
        unsafe_allow_html=True)
    st.markdown(" ")
    st.markdown(
        f"<div>Rate of return for this portfolio with Close-High: <span class='highlight red'>{ch}</span></span></div>",
        unsafe_allow_html=True)
    st.markdown(" ")
    st.markdown(
        f"<div>Rate of return for this portfolio with Low-High: <span class='highlight red'>{lh}</span></span></div>",
        unsafe_allow_html=True)
    st.markdown(" ")
    st.markdown(
...
def portfolio(coins_selected):
    ...
    st.markdown(
        f"<div>Rate of return for this portfolio with Close-Close: <span class='highlight red'>{ccr}</span></span></div>",
        unsafe_allow_html=True)
    st.markdown(" ")
    st.markdown(
        f"<div>Rate of return for this portfolio with Close-High: <span class='highlight red'>{chr}</span></span></div>",
        unsafe_allow_html=True)
    st.markdown(" ")
    st.markdown(
        f"<div>Rate of return for this portfolio with Low-High: <span class='highlight red'>{lhr}</span></span></div>",
        unsafe_allow_html=True)
    st.markdown(" ")
    st.markdown(
